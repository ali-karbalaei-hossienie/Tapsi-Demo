...
const accordianWrapper = document.querySelector(".accordian__wrapper");
accordianWrapper.addEventListener("click", function (e) {
  const accordian = e.target.closest(".accordian");
  if (!accordian) return;
  accordian.classList.toggle("accordian__expand");
});
